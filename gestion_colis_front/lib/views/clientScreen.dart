...
import 'package:gestion_colis/views/addClientScreen.dart';
...
class ClientScren extends StatefulWidget {
  @override
  _ClientScrenState createState() => _ClientScrenState();
}

class _ClientScrenState extends State<ClientScren> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: myAppBar("Gestion Clients"),
      floatingActionButton: FloatingActionButton(
        onPressed: () async=> await Navigator.of(context)
            .pushReplacement(MaterialPageRoute(builder: (context) => AddClientScren())),
